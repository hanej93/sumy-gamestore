  ...
  <main>
          ...
          <div class="g-pa-20">
                ...
                <tbody class="g-font-size-default g-color-black" id="accordion-09" role="tablist"
                  ...
                  <tr id="contact-1-header">
                    ...
                    <td
                      ...
                      <a class="d-flex align-items-center u-link-v5 g-color-black g-color-secondary--hover g-color-secondary--opened justify-content-center"
                        ...
                        <img
                          ...
                          src="/resources/static/assets/img-temp/100x100/img7.jpg" alt="Image Description">
                        <span class="">로스트사가</span>
                      </a>
                    </td>
                    <td
                    ...
                    <td
                      ...
                      <span class="">
                        <span class="u-label g-bg-secondary rounded g-mr-5">-30%</span>
                        <del class="g-color-gray-dark-v10">₩20,000</del>
                        <span class="g-ml-8">₩14,000</span>
                      </span>
                    </td>
                    <td
                      ...
                      <span class="g-hidden-sm-down">₩1,234,465,789</span>
                    </td>
                    <td
                      class="g-hidden-sm-down g-valign-middle g-brd-top-none g-brd-bottom g-brd-gray-light-v7 g-py-15 g-py-30--md text-center">
                      <span class="g-hidden-sm-down">98,765</span>
                    </td>
                    ...
                    <td
                      ...
                      <div class="d-flex align-items-center justify-content-center g-line-height-1">
                        <a class="u-link-v5 g-color-gray-light-v6 g-color-secondary--hover g-mr-15" href="#">
                            ...
                            <div class="modal-content">
                              <div class="modal-body">
                                <div class="row justify-content-center g-mx-5">
                                  ...
                                  <div>
                                    <a href="#" class="btn btn-lg u-btn-outline-primary u-btn-hover-v1-1 g-mr-10 g-font-size-14" data-toggle="modal" data-target="#exampleModal4" data-dismiss="modal">삭제</a>
            ...
            <nav aria-label="Page Navigation">
              <ul class="list-inline d-flex align-items-center justify-content-center g-my-60">
                ...
                <li class="list-inline-item g-hidden-sm-down g-mr-10">
                  <span
                    class="u-pagination-v1__item u-pagination-v1-2 g-bg-lightblue-v3--active g-color-gray-dark-v6 g-color-black--hover g-color-white--active g-brd-gray-light-v7 g-brd-lightblue-v3--hover g-brd-lightblue-v3--active g-px-18 g-py-12 g-rounded-4 active">2</span>
                </li>
                <li class="list-inline-item g-hidden-sm-down g-mr-10">
                  <a class="u-pagination-v1__item u-pagination-v1-2 g-bg-lightblue-v3--active g-color-gray-dark-v6 g-color-black--hover g-color-white--active g-brd-gray-light-v7 g-brd-lightblue-v3--hover g-brd-lightblue-v3--active g-px-18 g-py-12 g-rounded-4"
                    href="#">3</a>
    ...
    <script>
      ...
      $("button[type='reset']").click(function () {
        ...
        //console.log(slider.children().eq(1).css({ "left": "25%", "width": "50%" }));
        //console.log(slider.children().eq(2).css({ "left": "25%" }));
        //console.log(slider.children().eq(3).css({ "left": "75%" }));
