		...
		<div class="container g-py-100">
			<div class="row">
				<div class="g-brd-around g-brd-gray-light-v4 rounded g-mb-30"
					...
					onclick="location.href='page-our-stores-2.html';">
					...
					<div class="g-pa-20">
						...
						<div class="row">
							<div class="col-lg-9 g-mb-30">
								<h3 class="h6 g-color-gray-dark-v3">데이토즈의 ‘애니팡2’도 영국 킹 닷컴의
								...
								<div class="col g-mb-30">
									<span class="d-block g-color-text mb-2">작성일 : <span>2021-05-05
											13:12:01</span></span> <span class="d-block g-color-text mb-4">수정일 :
										<span>2021-05-05 13:12:01</span>
									</span>
								</div>

							</div>
							<div class="col g-mb-30">
								<img class="img-fluid" src="/resources/static/user/assets/img-temp/300x300/img1.jpg"
				...
				<div class="g-brd-around g-brd-gray-light-v4 rounded g-mb-30"
					...
					<div class="g-pa-20" src="/resources/static/user/assets/img-temp/300x100/img1.jpg">
						<!-- News Info -->
						<h2 class="h4 mb-3 mt-3">캔디크러쉬 사가가 50% 할인!!</h2>
